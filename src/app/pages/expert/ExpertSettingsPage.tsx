      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          {activeTab === "security" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-[#1A1A1A]/60 mb-6">
                  Protégez votre compte et vos données professionnelles
                </p>
              </div>
              ...
              <div className="bg-[#F5F1ED] rounded-2xl p-6 space-y-4">
                <h4 className="text-lg font-serif text-[#1A1A1A] mb-4 flex items-center gap-2">
                  <Lock className="w-5 h-5 text-[#A68B6F]" />
                  Mot de passe
                </h4>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <EyeOff className="w-5 h-5 text-[#1A1A1A]/40" />
                      ) : (
                        <Eye className="w-5 h-5 text-[#1A1A1A]/40" />
                      )}
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="password"
                      className="w-full pl-12 pr-4 py-3 bg-white border border-[#D4C5B9] rounded-xl text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#A68B6F]"
                    />
                  </div>
                </div>
          ...
          {activeTab === "availability" && (
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-serif text-[#1A1A1A] mb-2">Disponibilités</h3>
                <p className="text-sm text-[#1A1A1A]/60 mb-6">
              ...
              <div className="space-y-3">
                {days.map((day) => {
                  const settings = availabilitySettings[day.key as keyof typeof availabilitySettings];
                  return (
                    <div key={day.key} className="bg-[#F5F1ED] rounded-2xl p-6">
                      <div className="flex items-center gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-4">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setAvailabilitySettings({
                                    ...
                                    [day.key]: { ...settings, enabled: e.target.checked },
                                  })
                                }
                                className="sr-only peer"
                              />
                            ...
                            <span className="text-base font-medium text-[#1A1A1A]">{day.label}</span>
                          </div>

                          {settings.enabled && (
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <label className="block text-xs text-[#1A1A1A]/60 mb-2">Début</label>
                                <input
                                  type="time"
                                  ...
                                  onChange={(e) =>
                                    setAvailabilitySettings({
                                      ...availabilitySettings,
                                      [day.key]: { ...settings, start: e.target.value },
                                    })
                                  }
                                  className="w-full px-4 py-2 bg-white border border-[#D4C5B9] rounded-lg text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#A68B6F]"
                                />
                              </div>
                              <div>
                                <label className="block text-xs text-[#1A1A1A]/60 mb-2">Fin</label>
                                <input
                                  type="time"
                                  value={settings.end}
                                  onChange={(e) =>
                                    setAvailabilitySettings({
                                      ...availabilitySettings,
                                      [day.key]: { ...settings, end: e.target.value },
                                    })
                                  }
                                  className="w-full px-4 py-2 bg-white border border-[#D4C5B9] rounded-lg text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#A68B6F]"
                                />
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-900 mb-1">Synchronisation automatique</p>
                    <p className="text-xs text-blue-800 leading-relaxed">
                      Vos disponibilités seront synchronisées avec Cal.com pour la prise de rendez-vous
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Save button */}
          <div className="mt-8 pt-6 border-t border-[#D4C5B9] flex items-center justify-end gap-3">
